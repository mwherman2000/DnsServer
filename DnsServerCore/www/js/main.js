...
$(function () {
    ...
    $("#header").html("<div class=\"title\"><a href=\"/\"><img src=\"/img/logo25x25.png\" alt=\"Technitium Logo\" /><span class=\"text\" style=\"color: #ffffff;\">Trusted Digital Web - Data Registry</span></a>" + headerHtml + "</div>");
...
function resolveQuery(importRecords) {
    ...
    {
        var itype = type.indexOf("DID"); //mwh
        if (type === "ANY") itype = 0;
        ...
        if (idid == 0 && itype == 0) {
            ...
            showAlert("success", "Query by UDID", diddomain);
            domain = diddomain;
